namespace MudBlazorOnlineShop.Objects
{
    /// <summary>
    ...
    public class Product : ICloneable
    {
        ...
        public Product(string name, string description, decimal price, DateTime productionDate, DateTime expiryDate, double stock)
        {
            if (string.IsNullOrEmpty(name))
            {
                throw new ArgumentNullException(nameof(name));
